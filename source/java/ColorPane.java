...
public class ColorPane extends JTextPane {
	...
	/**
	 * Get the flag that indicates whether the pane is to track the width of its container.
	...
	/**
	 * Set the flag that indicates whether the pane is to track the width of its container.
